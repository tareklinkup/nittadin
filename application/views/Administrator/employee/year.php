...
function editYear(id) {
    var id = id;
    var inputdata = 'id=' + id;
    var urldata = "<?php echo base_url();?>editYear/" + id;
    $.ajax({
        type: "POST",
        url: urldata,
        data: inputdata,
        ...
        <span id="saveResult">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="year" name="year" placeholder="Year Name" value=""
    ...
    <div class="col-xs-12">
        ...
        <div id="">
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <?php 
					$query = $this->db->query("SELECT * FROM tbl_year order by year_id ASC ");
					$row = $query->result();
                    ...
                    <tr>
                        ...
                        <td><?php echo $i++; ?></td>
                        <td><a href="#"><?php echo $row->year_name; ?></a></td>
                        <td>
                            <?php if($this->session->userdata('accountType') != 'u'){?>
                            <div class="hidden-sm hidden-xs action-buttons">

                                <span class="green" style="cursor:pointer;"
                                    onclick="editYear(<?php echo $row->year_id; ?>);" title="Edit">
...
function updatedata() {
    ...
    var inputdata = 'year_id='
    year_id + '&year=' + year;
    //alert(inputdata);
    var urldata = "<?php echo base_url();?>updateYear";
    $.ajax({
        type: "POST",
        url: urldata,
        data: inputdata,
...
function Submitdata() {
    ...
    if (succes == "") {
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>insertYear";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
