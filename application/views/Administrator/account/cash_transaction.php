				...
				<div class="row">
					<div class="col-md-5 col-xs-12 col-md-offset-1">
						<div class="form-group">
							<label class="col-md-4 col-xs-5 control-label">Transaction Id</label>
						...
						<div class="form-group">
							<label class="col-md-4 col-xs-5 control-label">Transaction Type</label>
							<label class="col-md-1 col-xs-1">:</label>
							<div class="col-md-7 col-xs-12">
						...
						<div class="form-group">
							<label class="col-md-4 col-xs-5 control-label">Account</label>
							<label class="col-md-1 col-xs-1">:</label>
							<div class="col-md-6 col-xs-8">
								<select class="form-control" v-if="accounts.length == 0"></select>
								<v-select v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name" v-else></v-select>
								<!-- <v-select v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name" v-if="accounts.length > 0"></v-select> -->
							</div>
							<div class="col-md-1 col-xs-4" style="padding-left:0;margin-left: -3px;">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							<label class="col-md-4 col-xs-5 control-label">Amount</label>
							<label class="col-md-1 col-xs-1">:</label>
							<div class="col-md-7 col-xs-12">
						...
						<div class="form-group">
							<div class="col-md-7 col-xs-5 col-md-offset-5">
