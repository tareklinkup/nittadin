					...
					<div class="row">
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<v-select v-bind:options="customers" @search="inputSearch" label="display_name" v-model="selectedCustomer" v-on:input="customerOnChange"></v-select>
								</div>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-xs-8">
										<v-select v-if="!isProductFilterByBarcode" id="product" v-bind:options="products" ref="product" v-model="selectedProduct" label="display_text" v-on:input="productOnChange"></v-select>
			...
			<div class="table-responsive">
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						...
						<tr>
							<td colspan="3"><textarea style="width: 100%;font-size:13px;" placeholder="Note" v-model="sales.note"></textarea></td>
